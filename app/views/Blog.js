...
export class Blog extends React.Component {
    ...
    componentDidMount(){
        return fetch("https://public-api.wordpress.com/rest/v1.1/sites/tech593941099.wordpress.com/posts")
    ...
    chooseBlog = (blogID) => {
        this.state.navigation.navigate('BlogDetailRT', {blogID: blogID});
    }
